...
import type { Expense, Reference } from "./expenses.types";
...
export const fetchReferences = async () => {
  try {
    const response = await apiClient.get("/expenses/references");
    return response.data;
  } catch (error) {
...
export const createReference = async (data: Reference) => {
  try {
    const response = await apiClient.post("/expenses/references", data);
    return response.data;
  } catch (error) {
...
export const fetchReference = async (id: number) => {
  try {
    const response = await apiClient.get(`/expenses/references/${id}`);
    return response.data;
  } catch (error) {
